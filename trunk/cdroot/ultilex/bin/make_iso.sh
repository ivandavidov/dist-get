...
#
# modified by Ivan Davidov for 'ULTILEX/dist-get'
# ---------------------------------------------------

if [ "$1" = "--help" -o "$1" = "-h" ]; then
  echo "This script will create bootable ISO from files in 'cdroot' directory."
  echo "Current directory must be writable."
  echo "example: $0 ../../../ultilex.iso"
  exit
fi
...
-b ultilex/stuff/isolinux/isolinux.bin -c ultilex/stuff/isolinux/isolinux.boot ../../.
